...
namespace serialization{
    ...
    struct Serialize<NETWORK_ORDER,network::Frame<DATA,START,END>>{
        using type = network::Frame<DATA,START,END>;
    ...
    template<bool NETWORK_ORDER,typename START,typename DATA,typename END>
    struct Deserialize<NETWORK_ORDER,network::Frame<DATA,START,END>>{
        using type = network::Frame<DATA,START,END>;
    ...
    template<typename START,typename DATA,typename END>
    struct Serial_size<network::Frame<DATA,START,END>>{
        using type = network::Frame<DATA,START,END>;
    ...
    template<typename START,typename DATA,typename END>
    struct Min_serial_size<network::Frame<DATA,START,END>>{
        using type = network::Frame<DATA,START,END>;
    ...
    template<typename START,typename DATA,typename END>
    struct Max_serial_size<network::Frame<DATA,START,END>>{
        using type = network::Frame<DATA,START,END>;
        static constexpr size_t value = []()
        {
...
namespace network{
    template<typename START,typename DATA,typename END>
    serialization::SerializationEC Frame<START,DATA,END>::serialize(
    ...
    template<typename START,typename DATA,typename END>
    serialization::SerializationEC Frame<START,DATA,END>::deserialize(
    ...
    template<typename START,typename DATA,typename END>
    size_t Frame<START,DATA,END>::serial_size() const noexcept{
        return serialization::serial_size(frame_val_);
    }

    template<typename START,typename DATA,typename END>
    size_t Frame<START,DATA,END>::min_initial_size() const noexcept
    {
